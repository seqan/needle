...
TEST(ibf, insert)
{
    ...
    std::vector<uint16_t> medians_insert2 = insert(sequence_files_insert, ibf_args_insert, minimiser_args_insert, cutoffs_insert, "", tmp_dir/"IBF_Insert_Exp_", false);
...
TEST(ibf, insert_no_given_thresholds)
{
    std::filesystem::path tmp_dir = std::filesystem::temp_directory_path(); // get the temp directory
    estimate_ibf_arguments ibf_args{};
    minimiser_arguments minimiser_args{};
    ...
    std::vector<std::filesystem::path> sequence_files_insert = {std::string(DATA_INPUT_DIR) + "mini_example.fasta"};
    std::vector<uint16_t> medians_insert = ibf(sequence_files_insert, ibf_args_insert, minimiser_args_insert, fpr, cutoffs_insert);
    std::vector<uint16_t> medians_insert2 = insert(sequence_files_insert, ibf_args_insert, minimiser_args_insert, cutoffs_insert, "", tmp_dir/"IBF_Insert_Exp_", true);
